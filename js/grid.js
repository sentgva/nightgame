...
var PAL = {
  ...
  aura:       '#FBBF24',
  elite:      '#F43F5E',   // метка элиты четвёртого акта
  warp:       '#A855F7',   // разрывы, через которые ходит искажённый   // аура ревуна: враги вокруг ускоряются
  ...
  /* Акт 4 — Цитадель */
  uAltar:     '#FFF7AE',  uAltarF:    '#2E2A12',
  uBastion:   '#78909C',  uBastionF:  '#1A222A',
  uLancer:    '#00E5FF',  uLancerF:   '#0A2A30',
  uInquis:    '#FF6E40',  uInquisF:   '#2E1408',
  uWard:      '#B388FF',  uWardF:     '#1E1636',
