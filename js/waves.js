/* waves.js — конфигурация кампании.
   ...
   g(тип, количество, интервал, старт, колонка, опции) — группа врагов;
     ...
     опции: { hpMul: 2 } — усиление врага в конкретной волне.
...
var LEVELS = [
  ...
  {
    id: 4, name: 'дальний плевок', startSparks: 150,
  ...
  {
    id: 5, name: 'двойной натиск', startSparks: 175,
  ...
  {
    id: 6, name: 'под бронёй', startSparks: 175,
    unlock: ['shotgun'], hint: 'броня глотает первые 200 урона — дробовик снимет её быстрее',
    waves: [
      wave(g('walker', 4, 2.2, 0), g('armored', 1, 0, 4)),
      wave(g('walker', 4, 2.0, 0), g('armored', 1, 0, 3), g('runner', 2, 2.0, 6)),
      wave(g('walker', 4, 2.0, 0), g('armored', 2, 4.0, 3)),
      wave(g('walker', 5, 1.9, 0), g('armored', 2, 4.0, 2), g('spitter', 2, 2.5, 5)),
      wave(g('walker', 5, 1.8, 0, 1), g('walker', 4, 1.8, 1, 3), g('armored', 2, 4.0, 4)),
      wave(g('walker', 5, 1.8, 0), g('armored', 2, 3.5, 2), g('runner', 4, 1.6, 5)),
      wave(g('walker', 6, 1.7, 0), g('armored', 3, 3.5, 2), g('spitter', 2, 2.5, 6)),
      wave(g('walker', 6, 1.6, 0), g('armored', 3, 3.0, 2), g('runner', 4, 1.6, 6)),
      wave(g('walker', 7, 1.5, 0), g('armored', 3, 3.0, 2), g('spitter', 3, 2.2, 5)),
      wave(g('walker', 8, 1.4, 0), g('armored', 4, 2.8, 1), g('runner', 5, 1.5, 5), g('spitter', 2, 2.5, 9))
    ]
  },
  /* ---------- 7 ---------- появляются прыгуны */
  {
    id: 7, name: 'через ряд', startSparks: 200,
    unlock: [], hint: 'прыгун один раз перескочит через ряд — держи второй эшелон',
    waves: [
      wave(g('walker', 4, 2.2, 0), g('jumper', 1, 0, 4)),
      wave(g('walker', 4, 2.0, 0), g('jumper', 2, 3.0, 3)),
      wave(g('walker', 4, 2.0, 0), g('jumper', 2, 3.0, 2), g('runner', 2, 2.0, 6)),
      wave(g('walker', 5, 1.9, 0), g('jumper', 3, 2.5, 2), g('armored', 1, 0, 6)),
      wave(g('walker', 5, 1.8, 0), g('jumper', 3, 2.5, 2), g('spitter', 2, 2.5, 6)),
      wave(g('walker', 5, 1.8, 0, 0), g('walker', 4, 1.8, 1, 4), g('jumper', 3, 2.2, 3)),
      wave(g('walker', 6, 1.7, 0), g('jumper', 4, 2.2, 2), g('armored', 2, 3.5, 5)),
      wave(g('walker', 6, 1.6, 0), g('jumper', 4, 2.0, 2), g('runner', 4, 1.6, 6)),
      wave(g('walker', 7, 1.5, 0), g('jumper', 4, 2.0, 2), g('spitter', 3, 2.2, 6), g('armored', 2, 3.0, 8)),
      wave(g('walker', 8, 1.4, 0), g('jumper', 5, 1.8, 1), g('runner', 5, 1.5, 6), g('armored', 2, 3.0, 10))
    ]
  },
  /* ---------- 8 ---------- смешанные волны всех типов */
  {
    id: 8, name: 'всё разом', startSparks: 200,
    unlock: ['mine'], hint: 'мина дешева и снимает 300 урона — ставь её под броненосцев',
    waves: [
      wave(g('walker', 4, 2.0, 0), g('runner', 2, 2.0, 4), g('spitter', 1, 0, 6)),
      wave(g('walker', 4, 2.0, 0), g('armored', 1, 0, 2), g('jumper', 1, 0, 6)),
      wave(g('walker', 5, 1.9, 0), g('runner', 3, 1.8, 3), g('spitter', 2, 2.5, 6)),
      wave(g('walker', 5, 1.8, 0), g('armored', 2, 3.5, 2), g('jumper', 2, 2.5, 6)),
      wave(g('walker', 5, 1.8, 0, 1), g('walker', 4, 1.8, 1, 3), g('runner', 3, 1.8, 5), g('spitter', 2, 2.5, 7)),
      wave(g('walker', 6, 1.7, 0), g('armored', 2, 3.0, 2), g('jumper', 3, 2.2, 5), g('runner', 3, 1.8, 8)),
      wave(g('walker', 6, 1.6, 0), g('spitter', 3, 2.2, 2), g('armored', 3, 3.0, 5)),
      wave(g('walker', 7, 1.5, 0), g('jumper', 4, 2.0, 2), g('runner', 4, 1.6, 6), g('armored', 2, 3.0, 9)),
      wave(g('walker', 7, 1.5, 0), g('spitter', 4, 2.0, 1), g('armored', 3, 2.8, 5), g('jumper', 3, 2.2, 8)),
      wave(g('walker', 9, 1.3, 0), g('runner', 6, 1.4, 4), g('armored', 3, 2.6, 6), g('jumper', 4, 2.0, 9), g('spitter', 3, 2.2, 12))
    ]
  },
  /* ---------- 9 ---------- волны в три колонки одновременно */
  {
    id: 9, name: 'три фронта', startSparks: 225,
    unlock: [], hint: 'фронт идёт тремя колонками — не оставляй дыр',
    waves: [
      wave(g('walker', 3, 2.2, 0, 0), g('walker', 3, 2.2, 0.6, 2), g('walker', 3, 2.2, 1.2, 4)),
      wave(g('walker', 3, 2.0, 0, 1), g('runner', 3, 2.0, 0.6, 3), g('walker', 3, 2.0, 1.2, 0)),
      wave(g('walker', 4, 2.0, 0, 0), g('spitter', 2, 2.6, 1, 2), g('walker', 4, 2.0, 1.4, 4)),
      wave(g('armored', 2, 3.4, 0, 1), g('walker', 4, 1.9, 0.6, 3), g('runner', 3, 1.8, 1.2, 0)),
      wave(g('walker', 4, 1.9, 0, 0), g('jumper', 3, 2.2, 0.8, 2), g('walker', 4, 1.9, 1.4, 4)),
      wave(g('runner', 4, 1.7, 0, 1), g('armored', 2, 3.2, 0.8, 2), g('spitter', 3, 2.2, 1.4, 3)),
      wave(g('walker', 5, 1.7, 0, 0), g('walker', 5, 1.7, 0.7, 2), g('walker', 5, 1.7, 1.4, 4), g('jumper', 2, 2.5, 6)),
      wave(g('armored', 3, 3.0, 0, 2), g('runner', 5, 1.6, 0.8, 0), g('spitter', 3, 2.2, 1.4, 4)),
      wave(g('walker', 5, 1.6, 0, 1), g('jumper', 4, 2.0, 0.8, 3), g('armored', 2, 3.0, 1.4, 0), g('runner', 4, 1.6, 6)),
      wave(g('walker', 8, 1.3, 0), g('runner', 6, 1.4, 3), g('armored', 4, 2.4, 5), g('jumper', 4, 1.9, 8), g('spitter', 4, 2.0, 11))
    ]
  },
  /* ---------- 10 ---------- финал: все типы, максимальная плотность, два усиленных колосса */
  {
    id: 10, name: 'последний рубеж', startSparks: 250,
    unlock: [], hint: 'финал. два усиленных колосса на последней волне',
    waves: [
      wave(g('walker', 5, 1.8, 0), g('runner', 3, 1.8, 3), g('armored', 1, 0, 6)),
      wave(g('walker', 5, 1.8, 0, 1), g('walker', 5, 1.8, 0.8, 3), g('spitter', 2, 2.4, 5)),
      wave(g('armored', 3, 3.0, 0), g('runner', 5, 1.6, 2), g('jumper', 2, 2.4, 7)),
      wave(g('walker', 6, 1.6, 0, 0), g('walker', 6, 1.6, 0.8, 4), g('spitter', 3, 2.2, 4)),
      wave(g('boss', 1, 0, 3, 1), g('walker', 6, 1.8, 6), g('runner', 4, 1.6, 10)),
      wave(g('armored', 4, 2.6, 0), g('jumper', 4, 2.0, 3), g('runner', 5, 1.5, 6)),
      wave(g('walker', 6, 1.5, 0, 0), g('walker', 6, 1.5, 0.7, 2), g('walker', 6, 1.5, 1.4, 4)),
      wave(g('armored', 4, 2.4, 0), g('spitter', 4, 2.0, 2), g('jumper', 4, 1.9, 5), g('runner', 5, 1.5, 8)),
      wave(g('boss', 1, 0, 2, 3), g('walker', 8, 1.4, 5), g('armored', 3, 2.6, 8), g('jumper', 3, 2.2, 12)),
      wave(
        g('boss', 1, 0, 2, 0, { hpMul: 2 }),
        g('boss', 1, 0, 8, 3, { hpMul: 2 }),
        g('walker', 10, 1.3, 4),
        g('runner', 8, 1.3, 8),
        g('armored', 4, 2.4, 12),
        g('jumper', 5, 1.8, 16),
